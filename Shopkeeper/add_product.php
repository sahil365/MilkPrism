...
if(isset($_POST["submit"]))
{
	...
	if($ext=='jpg' || $ext=='jpeg' || $ext=='png' || $ext=='gif' || $ext=='jfif')
    {
      move_uploaded_file($tmp, $path);
		...
		$exe = $con -> query("INSERT INTO product(product_name,description,expiry_date,price,image,shop_id) VALUES('$product_name','$description','$p_expiry','$price','$filename','$selector1') ");
	}
						...
						<div class="form-three widget-shadow">
							<form class="form-horizontal" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="number" class="form-control1" id="price" name="price" placeholder="" required>
									</div>
								</div>
								<div class="form-group">
									<label for="price" class="col-sm-2 control-label">Product Expiry</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="expiry" name="expiry" placeholder="Best before 1 month" required>
									</div>
								</div>
								
								<!-- for getting shop id -->
								<input type="hidden" name="selector1" value="<?php echo $sh_id ?>" />
