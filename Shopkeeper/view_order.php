						...
						<table class="table">
							...
							<?php
								while($row = $category->fetch_object())
								{
									...
									$del_id = $row -> deliveryman_id;
									$delObj = $con -> query("select * from deliveryman where deliveryman_id='$del_id' ");
							...
							<?php
									...
									<?php if($row->isDelivered){ ?>
									<td colspan="3">Delivered by <b><?php echo $deli -> fname . ' '; echo $deli -> lname; ?> </b></td>
									<?php }?>
									</tr>
							<?php
								}
