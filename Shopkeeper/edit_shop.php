						...
						<h3 class="title1">Update Shop Details :</h3>
							<form class="form-horizontal" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="email" class="form-control1" id="shop_email" name="shop_email" value="<?php echo $result->shop_email;?>">
									</div>
								</div>
								<div class="form-group">
									<label for="shop_contact" class="col-sm-2 control-label">Shop Contact</label>
									<div class="col-sm-8">
										<input type="number" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  class="form-control1" id="shop_contact" name="shop_contact" value="<?php echo $result->shop_contact;?>">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="number" maxlength="6 " oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  id="pincode" name="pincode" class="form-control1" value="<?php echo $result->pincode; ?>">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="number" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  id="shopkeeper_contact" name="shopkeeper_contact" class="form-control1" value="<?php echo $result->shopkeeper_contact; ?>">
									</div>
								</div>
								<div class="form-group">
