					...
					<div class="login-body" style="padding-bottom: 32px;">
						<form action="" method="post" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<input type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  class="form-control" maxlength="10" id="shop_contact" name="shop_contact" placeholder="Enter Your Shop Contact" required="">
								</div>
								<div class="col-lg-6">
							...
							<div class="row">
								<div class="col-lg-6">
									<label>Pincode</label>
								<input type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  class="form-control" maxlength="6" id="pincode" name="pincode" placeholder="Enter Pincode" required="">
								</div>
								<div class="col-lg-6">
							...
							<div class="row">
								...
								<input type="password" style="padding-left:14px" class="form-control" minlength="8" id="password" name="password" placeholder="Enter Password" required="">
								</div>
								<div class="col-lg-6">
									<label>Confirm Password</label>
								<input type="password" style="padding-left:14px" class="form-control" minlength="8" id="cpassword" name="cpassword" placeholder="Enter Confirm Password" required="">
								<?php 
									if(isset($_POST['submit'])){
										if($password != $cpassword){
