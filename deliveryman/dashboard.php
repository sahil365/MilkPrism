...
$user_id = $_SESSION['deliveryman_id'];

$shop = $con->query("select * from shop");
$feedback = $con->query("select * from deliveryman_feedback where deliveryman_id='$user_id' ");
...
<body class="cbp-spmenu-push">
	<div class="main-content">
      ...
      <div class="col_3">
          ...
          <div class="col-md-4 widget widget1" style="margin-top:10px">
            <div class="r3_counter_box">
          ...
          <div class="col-md-4 widget" style="margin-top:10px">
            <div class="r3_counter_box">
