				...
				<h2 class="title1">Order Details</h2>
					<div class="panel-body widget-shadow">
						...
						<table class="table">
								...
								<tr>
									<td colspan="2"style="text-align: center;"><a class="btn btn-danger" href="order_delivered.php?o_id=<?php echo $obOrder->order_id; ?>&deliveryman_id=<?php echo $d_id; ?> ">Delivered</a></td>
								</tr>		
