					...
					<div class="login-body" style="padding-bottom: 32px;">
						<form action="" method="post" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<label>Contact</label>
								<input type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  class="form-control" maxlength="10" id="contact" name="contact" placeholder="Enter Your Contact Number" required="">
								</div>
							</div>
							<div class="row">
							<div class="col-lg-12">
							...
							<div class="row">
								...
								<input type="password" class="form-control" id="password" minlength="8" name="password" placeholder="Enter Password" required="">
								</div>
								<div class="col-lg-6">
									<label>Confirm Password</label>
								<input type="password" class="form-control" id="cpassword" minlength="8" name="cpassword" placeholder="Enter Confirm Password" required="">
								</div>
							</div>
							<div class="row">
