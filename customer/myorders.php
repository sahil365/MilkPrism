            ...
            <div class="container">
                <div class="row w-100">
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <table id="shoppingCart" class="table table-condensed table-responsive">
                            <thead>
                                <tr>
                                    <th style="width:68%;font-size:1.1rem">Product</th>
                                    <th style="width:12%;font-size:1.1rem">Price</th>
                                    <th style="width:10%;font-size:1.1rem">Quantity</th>
                                    <th style="width:10%;font-size:1.1rem">Sub Total</th>
                            ...
                            <tbody>
                                ...
                                while ($row = $order->fetch_object()) {
                                    ...
                                    $deli_id = $row->deliveryman_id;

                                    $delObj = $con -> query("select * from deliveryman where deliveryman_id='$deli_id' ");
                                    $deli = $delObj -> fetch_object();
                                ?>
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <?php if($row->isDelivered == 1){ ?>
                                                <p style="margin:0px;padding:0px">Delivered by <b><?php echo $deli -> fname . ' '; echo $deli -> lname; ?> </b></p>
                                            <?php } else{ ?>
                ...
                <div class="col-sm-6 mb-3 mb-m-1 order-md-1 text-md-left">
                    ...
                    <div class="col-sm-6 mb-3 mb-m-1 order-md-1 text-md-right">
                        <button class="btn btn-danger" style="border-radius: 5px;box-shadow:0px 0px 5px gray" onclick="window.print()">Print Order History</button>
                    </div>
                </div>
            </div>
        </section>
