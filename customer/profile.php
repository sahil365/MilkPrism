        ...
        <div style="padding:20px" class="col-sm-12">
          ...
          <form method="post">
            ...
            <div style="margin-top:10px;" class="row">
              ...
              <div class="col-sm-8"><input type="number" name="contact" id="contact" placeholder="Enter Contact" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  maxlength="10" class="form-control input-sm" value="<?php echo $result->contact; ?>"></div>
            </div>
            ...
            <div style="margin-top:10px;" class="row">
              ...
              <div class="col-sm-8"><input type="number" name="pincode" id="pincode" maxlength="6" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  placeholder="Enter Pincode" class="form-control input-sm" value="<?php echo $result->pincode; ?>"></div>
            </div>
            <div style="margin-top:10px;" class="row">
