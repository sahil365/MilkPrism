                ...
                <div style="padding:20px" class="col-sm-6">
                    ...
                    <form method="post">
                        ...
                        <div style="margin-top:10px;" class="row">
                            ...
                            <div class="col-sm-8"><input type="number" id="contact" name="contact" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="Enter Mobile Number" maxlength="10" class="form-control input-sm" required></div>
                        </div>
                        <div style="margin-top:10px;" class="row">
