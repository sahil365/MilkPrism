...
$shopOb = $con->query("select * from shop where shop_id='$shop_id' ");
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-sm-12">
                        <img src="../Shopkeeper/upload/<?php echo "$result->image" ?>" style="box-shadow:0px 0px 0px;border-radius:20px">
                    </div>
                    <div class="col-md-7 col-sm-12">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item list-group-item-primary "><b>Expiry : </b><?php echo $result->expiry_date; ?></li>
                            <li class="list-group-item list-group-item-primary "><b>Shop Name : </b><?php echo $shop_fet_ob->shop_name ?></li>
