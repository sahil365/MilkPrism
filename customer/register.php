        ...
        <div style="padding:20px" class="col-sm-6">
          ...
          <form method="post" enctype="multipart/form-data">
            ...
            <div style="margin-top:10px;" class="row">
              ...
              if (isset($_POST['submit'])) {
                if ($rowcount == 1){
                  ...
                  echo '<div class="col-sm-8 alert alert-danger text-center" role="alert">Email already exists !!</div>';
                }
              }
            ...
            <div style="margin-top:10px;" class="row">
              ...
              <div class="col-sm-8"><input type="number" id="contact" name="contact" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  placeholder="Enter Contact" class="form-control input-sm" required></div>
            </div>
            <div style="margin-top:10px;" class="row">
            ...
            <div style="margin-top:10px;" class="row">
              ...
              <div class="col-sm-8"><input type="password" id="password" name="password" minlength="8" placeholder="Enter Password" class="form-control input-sm" required></div>
            </div>
            <div style="margin-top:10px;" class="row">
              <div style="padding-top:10px;" class="col-sm-3"><label>Confirm Password:</label></div>
              <div class="col-sm-8"><input type="password" id="cpassword" name="cpassword" minlength="8" placeholder="Enter Confirm Password" class="form-control input-sm" required></div>
              <?php
              if (isset($_POST['submit'])) {
                if ($password != $cpassword) {
