                ...
                <div style="padding:20px" class="col-sm-6">
                    ...
                    <form method="post">
                        ...
                        <div class="row" style="margin-top:20px">
                            ...
                            <div class="col-sm-8"><input type="number" min="1" max="5" placeholder="Enter value out of 5" id="name" name="rating" class="form-control input-sm" required oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="1" ></div>
                        </div>
