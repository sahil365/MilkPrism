           ...
           <div class="row">
            ...
            <h2 style="margin-bottom:20px">Change Password</h2>
                ...
                <div style="margin-top:10px;" class="row">
                    ...
                    <div class="col-sm-8"><input type="password" name="opassword" minlength="8" id="opassword" placeholder="Enter Old Password" class="form-control input-sm" value="" required>
                    <?php
                        if(isset($_POST['submit'])){
                            if($rowcount != 1){
                 ...
                 <div style="margin-top:10px;" class="row">
                    ...
                    <div class="col-sm-8">
                      <input type="password" name="npassword" id="npassword" minlength="8" placeholder="Enter New Password" class="form-control input-sm" value="" required  >
                    </div>
                </div>

                <div style="margin-top:10px;" class="row">
                    <div style="padding-top:10px;" class="col-sm-3"><label>Confirm New Password :</label></div>
                    <div class="col-sm-8"><input type="password" name="cpassword" minlength="8" id="cpassword" placeholder="ReEnter New Password" class="form-control input-sm" value="" required  >
                        <?php
                            if(isset($_POST['submit'])){
                                if($newpassword != $cnewpassword){
