						...
						<div class="form-three widget-shadow">
							<form class="form-horizontal" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-8"><select name="selector1" id="selector1" class="form-control1" required>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="area_name" name="area_name" placeholder="" required>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group text-center">
									<?php 
										if(isset($exe)){
											if($exe)
											{
											echo '<div class="alert alert-success" role="alert">Area Added Successfully !!</div>';
											}
											else
											{
