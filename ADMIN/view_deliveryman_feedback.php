...
$category = $con->query("select * from deliveryman_feedback");
						...
						<table class="table">
							...
							<?php
								while($row = $category->fetch_object())
								{
									...
									$shop = $con->query("select * from deliveryman where deliveryman_id='$row->deliveryman_id'");
									$s = $shop->fetch_object();

                                    $deliverymanFullName = $s -> fname . ' ' . $s -> lname;
							?>
							<tbody>
								<tr>
								  <th scope="row"><?php echo "$row->feedback_id"; ?></th>
								  <td><?php echo "$cust->name"; ?></td>
								  <td><?php echo "$deliverymanFullName"; ?></td>
